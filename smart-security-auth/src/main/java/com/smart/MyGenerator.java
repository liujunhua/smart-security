...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        String mircoServiceName = scanner("微服务名（不包含smart，以 '-' 间隔，例如security-auth）");
        gc.setOutputDir(projectPath + "/" + projectName + "-" + mircoServiceName + "/src/main/java");
        gc.setAuthor("liujunhua");
        gc.setOpen(false);
        gc.setSwagger2(true);
        ...
        dsc.setUrl("jdbc:mysql://192.168.2.215:3306/hydra_security?useUnicode=true&useSSL=false&characterEncoding=utf8");
